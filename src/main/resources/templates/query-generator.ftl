package ${apiModel.servicePackage}.${apiModel.apiPackage}.generator;
...
<#assign extendsForEntity = "HvlEntityQueryGenerator<${apiModel.apiName}QueryModel, ${apiModel.apiName}EntityQuery>">
<#assign extendsForView = "HvlViewQueryGenerator<${apiModel.apiName}QueryModel, ${apiModel.apiName}EntityQuery>">

@Component
<#if apiModel.isView()>
public class ${apiModel.apiName}QueryGenerator extends ${extendsForView} {
<#else >
public class ${apiModel.apiName}QueryGenerator extends ${extendsForEntity} {
</#if>
