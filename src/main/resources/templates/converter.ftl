package ${apiModel.servicePackage}.${apiModel.apiPackage}.converter;
...
<#assign extendsBy = "HvlGenericMapStructMapper<${apiModel.apiName}Model, ${apiModel.apiName}Entity>">
@Mapper
public interface ${apiModel.apiName}Converter extends ${extendsBy} {
